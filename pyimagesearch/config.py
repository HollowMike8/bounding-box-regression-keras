...
path_dir = "/content/bounding-box-regression-keras"
base_path = "dataset"
images_path = os.path.join(path_dir, base_path, "images")
annotations_path = os.path.join(path_dir, base_path, "airplanes.csv")
...
plot_path = os.path.join(path_dir, base_output, "plot.png")
test_filenames = os.path.join(path_dir, base_output, "test_images.txt")
